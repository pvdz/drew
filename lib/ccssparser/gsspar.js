...
var GssParser = (typeof module === 'undefined' ? {} : module).exports = (function(){
  var VERBOSE = false;
  ...
  function GssParser(gssTokens, input){
    $gssTokens = gssTokens; // _all_ tokens for this gss rule, left to right
    $input = input; // for debugging
  ...
  function parseRule() {
    ...
    if (requireIdent) {
      ...
      // the important and `!` to the array here and callers of GssParser
